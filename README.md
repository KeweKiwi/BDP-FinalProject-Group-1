...
> This screenshot displays the initial Spark SQL execution logs. It includes the detected dataset schema and event type distribution (view, cart, and purchase), confirming that Spark successfully read and parsed the dataset from HDFS.
>
...
> This screenshot displays the dashboard overview section. The KPI cards summarize key business metrics such as total views, purchases, revenue, and conversion rate. The funnel visualization illustrates customer progression from product viewing to cart additions and final purchases.
>
